...
> **v1.2.0 부터 릴리스 노트는 [GitHub Releases](https://github.com/Chigo55/Docker-Compose/releases) 에서
> 병합된 PR 로부터 자동 생성합니다.** 병렬 PR 이 `[Unreleased]` 에서 충돌하던 문제를 없애기 위해
> 수기 관리를 폐지했습니다([ADR-0020](.claude/adr/0020-generate-release-notes-from-prs.md),
> [#44](https://github.com/Chigo55/Docker-Compose/issues/44)). 아래는 **v1.1.1 까지의 이력**이며
> 갱신하지 않습니다 — 이후 변경은 Releases 탭을 보세요.
