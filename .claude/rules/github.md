...
- `docs/ROADMAP.md` 는 **동결된 초기 스냅샷**이라 갱신하지 않는다([ADR-0016](../adr/0016-track-in-github-not-docs.md)).
- 마일스톤은 쓰지 않는다(0건).
...
| private vulnerability reporting | ❌ 미설정 — [#28](https://github.com/Chigo55/Docker-Compose/issues/28) 에서 추적 |
| `SECURITY.md` | ❌ 없음 — [#28](https://github.com/Chigo55/Docker-Compose/issues/28) |
