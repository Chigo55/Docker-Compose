...
- [ ] 새 스크립트를 추가했다면 **`docs/scripts/<name>.md`**(맨 위 `summary` frontmatter)를 함께 만들었다. `docs/README.md` 나 목록 표는 건드리지 않았다 ([ADR-0022](https://github.com/Chigo55/Docker-Compose/blob/main/.claude/adr/0022-per-script-docs.md))
